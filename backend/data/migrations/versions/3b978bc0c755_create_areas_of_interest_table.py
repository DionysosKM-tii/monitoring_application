...
Revision ID: 3b978bc0c755
Revises: 
Create Date: 2025-10-08 12:32:27.866014
...
def upgrade() -> None:
    ...
    op.create_table('areas_of_interest',
                    ...
                    sa.Column('geometry',
                              Geometry(geometry_type='POLYGON', srid=4326, dimension=2, from_text='ST_GeomFromEWKT',
...
def downgrade() -> None:
    ...
    op.create_index(op.f('place_lookup_name_idx'), 'place_lookup', [sa.literal_column('soundex(name::text)')],
                    unique=False)
    op.create_table('state_lookup',
                    ...
                    sa.UniqueConstraint('abbrev', name=op.f('state_lookup_abbrev_key'), postgresql_include=[],
                                        postgresql_nulls_not_distinct=False),
                    sa.UniqueConstraint('name', name=op.f('state_lookup_name_key'), postgresql_include=[],
                                        postgresql_nulls_not_distinct=False),
                    sa.UniqueConstraint('statefp', name=op.f('state_lookup_statefp_key'), postgresql_include=[],
                                        postgresql_nulls_not_distinct=False)
                    )
    ...
    op.create_table('faces',
                    ...
                    sa.Column('the_geom',
                              Geometry(dimension=2, from_text='ST_GeomFromEWKT', name='geometry',
    ...
    op.create_table('tabblock20',
                    ...
                    sa.Column('intptlon', sa.VARCHAR(length=12), autoincrement=False, nullable=True),
                    sa.Column('the_geom',
                              Geometry(geometry_type='MULTIPOLYGON', srid=4269, dimension=2,
    ...
    op.create_table('zcta5',
                    ...
                    sa.Column('the_geom',
                              Geometry(dimension=2, spatial_index=False, from_text='ST_GeomFromEWKT',
                                                         name='geometry', _spatial_index_reflected=True),
                              autoincrement=False, nullable=True),
                    sa.CheckConstraint("geometrytype(the_geom) = 'MULTIPOLYGON'::text OR the_geom IS NULL",
                                       name=op.f('enforce_geotype_the_geom')),
    ...
    op.create_table('state',
                    ...
                    sa.UniqueConstraint('gid', name=op.f('uidx_tiger_state_gid'), postgresql_include=[],
                                        postgresql_nulls_not_distinct=False),
                    sa.UniqueConstraint('stusps', name=op.f('uidx_tiger_state_stusps'), postgresql_include=[],
                                        postgresql_nulls_not_distinct=False)
                    )
    ...
    op.create_index(op.f('county_lookup_name_idx'), 'county_lookup', [sa.literal_column('soundex(name::text)')],
                    unique=False)
    ...
    op.create_index(op.f('idx_tiger_featnames_snd_name'), 'featnames', [sa.literal_column('soundex(name::text)')],
                    unique=False)
    op.create_index(op.f('idx_tiger_featnames_lname'), 'featnames', [sa.literal_column('lower(name::text)')],
                    unique=False)
    ...
    op.create_index(op.f('countysub_lookup_name_idx'), 'countysub_lookup', [sa.literal_column('soundex(name::text)')],
                    unique=False)
    ...
    op.drop_index('idx_areas_of_interest_geometry', table_name='areas_of_interest', postgresql_using='gist')
